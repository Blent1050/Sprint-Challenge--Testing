...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
   - Describe is to describe the code you will be testing. it is a specific peice of that code your testing.
2. What is the point of `Test Driven Development`? What do you think about this approach?
   1. TDD is to test while developing code. This approach seems like one of the best approaches to developing an app because you will be able to have coverage on most of your code and spot bugs early on.
3. Mention three types of automated tests.
   1. Unit test, regression test, API test.
